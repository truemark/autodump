...
new AutoDumpStack(app, 'AutoDump', {
  ...
  privateSubnetIds: ["subnet-00cd7a0602e4f0f09", "subnet-08e5109899e63da57", "subnet-042e37e02217a69d3"], // TODO Populate from your dev account, it's fine to check in, we'll remove it later
